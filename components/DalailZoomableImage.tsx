...
export function DalailZoomableImage({
    source,
    width,
    height,
    onPress,
        ...
        <View style={{ width, height }}>
            <GestureDetector gesture={gesture}>
                <Animated.View style={[styles.imageWrap, { width, height }, animatedStyle]}>
                    <Image source={source} style={{ width, height }} contentFit="contain" onError={onError} />
                </Animated.View>
            </GestureDetector>
        </View>
    );
