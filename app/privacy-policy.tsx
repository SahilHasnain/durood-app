                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    ...
                    <section>
                        ...
                        <p style={{
                            ...
                            Durood Moments is designed with privacy in mind. We collect minimal
                            information:
                        </p>
                        <ul style={{
                            marginLeft: "24px",
                            ...
                            <li>Durood counter progress (stored locally on your device)</li>
                            <li>Video viewing history (stored locally on your device)</li>
                            <li>App preferences and settings (stored locally on your device)</li>
                            <li>Optional user account information (if you choose to create an account)</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul style={{
                            ...
                            <li>Track your Durood recitation progress</li>
                            <li>Remember your preferences and settings</li>
                            <li>Improve app performance and user experience</li>
                            <li>Sync your progress across devices (if you create an account)</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p style={{
                            ...
                            primarily stored locally on your device. If you create an account,
                            some data may be stored securely on our servers to enable
                    ...
                    <section>
                        ...
                        <ul style={{
                            ...
                            <li>Cloud storage for data synchronization</li>
                    ...
                    <section>
                        ...
                        <ul style={{
                            ...
                            <li>Delete your data by uninstalling the app or deleting your account</li>
